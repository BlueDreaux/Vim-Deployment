...
syn keyword vbnetCharacter		vbCrLf
...
if ! exists("vbnet_no_functions")
    ...
    syn keyword vbnetMSStrings Abort Asc AscW Chr ChrW Close Delay Filter Format FormatCurrency FormatDateTime FormatNumber FormatPercent GetChar InStr InStrRev Join LCase Left Len Length LSet LTrim Mid Name Open Replace Right RSet RTrim Sleep Space Split Start StrComp StrConv StrDup StrReverse Trim UCase
